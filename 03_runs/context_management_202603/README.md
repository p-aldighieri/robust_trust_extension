...
Critical rule: refreshing a durable file means updating it through the project `Sources` tab. A composer attachment does not refresh project-level context.
...
3. Check whether the project-level sources are correct and refresh any durable file that changed locally.
