...
========
ROLE: user (id=1a20de5f-d254-4320-8909-85d1462dc871)
========
...
========
ROLE: assistant (id=93bde347-872f-49da-ac7f-64e6889e8a39)
========
lean_proof
target_lemma_slug: q_dominates_tau_when_alpha_pos
status: PROVED
tactics_used: [have, exact, simpa]
proof_length_lines: 11
introduces_have_clauses: 3
lean
theorem q_dominates_tau_when_alpha_pos
    (model : RobustTrustModel)
    (β : AdviserKernel model)
    ...
    (hP : ∀ᵐ m ∂MixtureMessageLaw model β, P m) :
    ∀ᵐ m ∂model.τM, P m := by
  have hc : ENNReal.ofReal model.α ≠ 0 := by
    exact ne_of_gt (ENNReal.ofReal_pos.mpr hα)
  have hτ_ac : model.τM ≪ MixtureMessageLaw model β := by
    have hscaled :
        model.τM ≪ (ENNReal.ofReal model.α) • model.τM :=
