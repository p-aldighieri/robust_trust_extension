...
========
ROLE: user (id=20ba9890-6b8b-4d9c-9384-b942d127cbcd)
========
...
========
ROLE: assistant (id=f867db69-d3e1-47fc-884b-68cc2e016515)
========
lean_proof
target_lemma_slug: compact_menu_space_compact
status: PROVED
tactics_used: ["haveI", "simpa", "change", "infer_instance"]
proof_length_lines: 4
introduces_have_clauses: 1
lean
theorem compact_menu_space_compact
    (model : RobustTrustModel)
    (prs : ProfileRealizationSetup model) :
