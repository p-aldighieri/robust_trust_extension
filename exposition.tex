...
\subsection{A8c-attain is tight: the upward-spike row obstruction (Q1)}
...
\subsection{TRE-gen-Hall is tight: a ternary non-radial separating witness (Q2)}
...
Proof logs (intermediate prover outputs, reviewer verdicts,
counterexample constructions) are committed in the proof repository
under \texttt{packets/} and \texttt{logs/}.
