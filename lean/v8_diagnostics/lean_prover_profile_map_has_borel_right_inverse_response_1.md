...
========
ROLE: user (id=ecb57393-389e-483a-9cc2-6a9ae3442db0)
========
...
========
ROLE: assistant (id=8e61820a-1bfa-4ea0-ac72-d91e0ab2b6d2)
========
lean_proof
target_lemma_slug: profile_map_has_borel_right_inverse
status: PROVED
tactics_used: [classical, have, let, rcases, refine, apply, rw, change, simpa, Subtype.ext]
lean
theorem profile_map_has_borel_right_inverse
    (model : RobustTrustModel)
    (prs : ProfileRealizationSetup model) :
